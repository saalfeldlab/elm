 ...
 *
 */
public class LandmarkTableModelLight extends AbstractTableModel {
	...
	public final Logger logger = LogManager.getLogger( LandmarkTableModelLight.class.getName() );

	public LandmarkTableModelLight( int ndims )
	{
		super();
		this.ndims = ndims;
...
//				String s = "" + i + " : ";
	 ...
	 * @return
	 */
	public LandmarkTableModelLight invert()
	{
		LandmarkTableModelLight inv = new LandmarkTableModelLight( ndims );
